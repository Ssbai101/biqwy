...
<!-- 用户添加 界面-->  
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">管理员信息</a><span class="crumb-step">&gt;</span><span>添加信息</span></div>
        </div>
                ...
                <form action="/biqwy/manage/admin_douseradd" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>地址：</th>
                                <td><input class="common-text" name="addr" size="50" value="" type="text"></td>
                            </t>
